...
INSERT INTO user (name, email,password,role,probation)  VALUES  
	...
	('Sajid Mahmoood', 'sajidm@web.de', 'A1b2c#d0',1,false),
...
INSERT INTO user (name, email,password,role,probation,birthday,address)  VALUES  
	('Sajid Mahmood', 'sajidm@mifon.tk', 'A1b2c#d0',1,false,'1974-02-20','32 Squires Gate,Rogerstone, Newport,UK,NP100BP');
INSERT INTO user (name, email,password,role,probation,organisation_ID)  VALUES
	...
	('Karl-Heinz Oliv', 'kho@mifon.tk', 'A1b2c#d0',1,false,1),
	('Gerhard Shaub', 'gerhards@mifon.tk', 'A1b2c#d0',1,false,2);
