CREATE TABLE IF NOT EXISTS user (
   ...
   PRIMARY KEY (id),
   UNIQUE KEY (email),
   FOREIGN KEY (organisationID) REFERENCES organisation(id) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
INSERT INTO user (name, email,password,role,probation,organisationID)  VALUES
